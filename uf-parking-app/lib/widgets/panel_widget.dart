/*
    ...
    To-do:
      1. Create search bar [NEW ITEM ADDED]
        ...
        - Refresh list items to database info when search bar is empty
      2. Make list tiles buttons
        ...
        - On list tile click, center camera position to location coordinates [DONE]
      3. Make info state widget
        - enable parallax to center location marker [DONE]
        - animate transition between panel states
        - Fix onSlide function (Returning to list when still in panel state)
        - Display and format parking area info
        - Have icon to go back to search list [DONE]
        - If search bar is selected, change back to search list
      4. Markers
        - Have click on marker activate info state widget
        - Have markers display color of primary decal
        - List applicable decals
      5. Gestures
